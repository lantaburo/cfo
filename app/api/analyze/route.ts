...
3. **Dana Darurat Otomatis**: Anda WAJIB menghitung dan menambahkan 'Dana Darurat' ke dalam \`goal_projections\`. Rumus perhitungan \`target_amount\` HARUS persis seperti ini:
   ...
   - Periode (Bulan) adalah TETAP 12 BULAN (Dana Darurat Ideal).
   - Dana Darurat Ideal = Kebutuhan DD per bulan x 12.
   - Target Dana Darurat (\`target_amount\`) = 30% x Dana Darurat Ideal (TIDAK PERLU DIBULATKAN, biarkan nominal aslinya).
